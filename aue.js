const db =
{
  ...
  "interpretations": [
    ...
    ["Promise", "Only declare promises you know you can keep, & if expectations must be changed seek consent from the other. Promises to the dead are meaningless.", "hno"],
    ...
    ["Slavery", "Seek out & eliminate the enslavement of others, or encouragement into servitude, & ensure executives similarly laboured themselves.", "klmnopqrs"],
    ...
    ["Hygiene", "Keep yourself & your environment hygienic & your immunity strong, & mitigate the spread of disease.", "lmnopstu"],
