const db = {
  ...
  "interpretations": [
    ...
    ["Art", "Seek awareness of art and its importance on challenging or reinforcing cognitive behaviour and belief.", "ehklmnoq"],
  ...
  "verseDescriptions": [
    ...
    <b>Think sensibly for Aue.</b> It's a very direct verse, calling upon innate abilities we all have, to discover Aue. Aue is not written so much for its face value, rather to be studied until understood, with serious attitude.
    The interpretations encourage a regular revision of Aue in respect to one's life, and publicly so.`],
    ["b", `This verse is cited in my first five interpretations of Aue, and they touch upon not just Aue's propagation, but also on a time which can be really hard to keep faith - austerity.
    One may read Aue, understand, and benefit, but when times are tough it can be easy to drop empathy and abandon any "peace-time" morals. Aue has no conditional clause saying "have faith, only when times are good"; you are asked to have faith not only in Aue, but yourself.
    With study one could make peace with Aue, so even in the hardest times, or the quickest judgements, you can rely on it. My interpretations also ask that you remain humble when times are good, and not to shun Aue or others.
    Other citations to it are to its propagation and celebration. There must be belief in it and understanding if to be taught without restraint, translated without misjudgement, celebrated without feeling false. Thankfully, with group and personal revision, few should be unable to do this!`],
    ...
    And now is a good time to focus on a core concept of Aue: <b>joy</b>. A state of happiness, felicity, it is mentioned throughout Aue, coveted. Further verses will allude to its relationship with <b>woe</b>. Aue asks in verse <i>k</i>: <b>Know of woe and seek joy happily.</b>
    Therefore an adherent should include these revelations in their revisions, summaries, and remember what Aue clearly states to be: <b>This is knowledge, to share, preserve, for joy.</b>`],
    ["d", `Simply, with access to the Aue doctrine one could rejoice. However, do not mistaken pointing at the moon for the moon itself! The first time th is read one won't be feel particularly joyful.
    Remember, Aue is to be studied until it makes sense. Each time this verse is read across - as it should, as all are important - hopefully the joy has grown. And, one might also feel the need to impart this knowledge onto others as I am.
    Two interpretations that cite this verse are <i>Reflection</i> and <i>Gratitude</i>. These constitute a reflection upon reality, and particularly a gratuitous reflection for those who bring you joy. Gratitude has a fairly weak citation, but just as you might feel joy for Aue, rejoice for other things in life - a recurring cycle. Aue is all about seeing the wonderful opportunity for joy we were born into, and the capacity we have for it, with billions of fellow humans, an uncountable number of other beings, and having been born from the exact conditions for our livelihood.
    And so I do sincerely hope, dear reader, you will be able to feel some joy; <b>it is shared to you, rejoice!</b>`],
    ["e", `Aue has asked an adherent to rejoice for Aue being shared to them, and now it asks that one record and speak of the joy. It is all that one discovers through the lens of Aue. In further verses one is asked to seek joy in response to woe, and to demonstrate Aue in response to woeful behaviour. Further, we are asked to ensure it is a happy pursuit!
    <b>Record, speak, listen to the joy.</b> Why? To help the propagation of Aue and therefore the joy that comes with it, and to codify appraisal and history. One could quietly and solitarily follow Aue, but that would virtually denying any benefits one experiences for others.`],
    ...
    ["h", `Some wonder why there is joy and woe in the world at the same time, why it is experienced unequally. It is simply nature and the fittest way to survive our environments. Plants and even microbes will respond to positive and negative stimuli &mdash; a dichotomy which we intelligent beings apply. They do not understand what is positive and negative, with only genetic impetus. These genes are the product of innumerable mutations alongside innumerable environmental pressures &mdash; evolution. Our acute sense of joy and woe is owed to our consciousness.
    ...
    ["j", `As previous verses have established, after death is scattering, and it is a certainty for all of us. Maybe advances in medicine will improve our lifespans within our lifetime, but even with an extra 100 years, or 1000 years, or one trillion, our time is volatile and short. This means weshould take care to use our life well, and realise how precious it is.
    With previous interpretations, four interpretations commencing with <i>j</i> are <i>Slavery</i>, to help ensure nobody lives their life without freedom; <i>Shame</i> to help ensure nobody restricts their life choices just because others feel offended; <i>Exercise</i> a short simple encouragement for the gym to not just waste energy on resistance; <i>Technological inertia</i> encourages being aware of (seeking) socially valuable technology that should be adopted without delay, factoring in hardships.
    More interpretations may draw upon this verse just to remind people to not waste their lives. Even I must be reminded sometimes.`],
    ["k", `All a religion without supernatural means can do is inspire—move—one to act and think differently. Aue is no exception. Its ~140 words can only be written in a way that after study it makes sense, then causes change. Of course you could approach anybody on the street and say: <b>Know of woe and seek joy happily.</b> But while this verse is one of the most important, it is only words, and it's up to the adherent to effect its importance.
    In religion there is often dichotomy between good & evil, virtue & sin, and joy & woe is of Aue. <b>Know of woe</b> is an entire life's journey with conscious, empathetic heart and mind. It means to uncover all national plight, all manner of personal grievance, and even the condition and treatment of life itself. <b>and seek joy</b> is on this same path, to effect it in both yourself and others.
    You've read the words, now <i>a</i> <b>Think sensibly for Aue;</b> and read them again to inspire action!`],
    ["l", `To me, religion requires faith. And to me, this is the core faith of Aue.
    There is a compulsion in modern, especially capitalist society, to become alienated from all but yourself. And yet as human beings we would be completely unrecognisable without society, and nonexistent without nature.
    Society is the sum of all our interactions with one another, and can be shared with anybody except by yourself alone. By trusting & relying on nature & society, we accept a part of ourselves just as important as our flesh.`],
    ["m", `One might find it apparent to oppose harm to others, but this verse serves as the steadfast reminder. Aue lays out the character of joy & woe, and asks for this to be consistently kept in mind, and its diversity investigated.
    The <b>it</b> is <b>nature & society</b> (<i>l</i>), with sentient beings making up that society. Opposing harm and upholding good involves numerous actions.
    Taking anthropogenic climate change as a currently most important issue, it will take massive corrections and pressures in our behaviour and governance to address. The normalisation and unnecessary systematic torture and slaughter of billions of animals globally must be addressed. Hundreds of millions of individuals globally are suffering in war, persecution, genocide, poverty, economic debt or slavery, and more, and must be saved. And locally, there may be individuals or families in need which can be directly helped. These issues, an adherent of Aue should tackle head-on, for joy.
    But how much should one change? Where is the line drawn? This is a question that can regress into a return to primitive life or even to excuse suicide. But this insults our capacity for doing good, and may make one feel apathetic. We all have the ability to seek out, prioritise, and create real lasting impact in this world. It is with faith that adherents of Aue should do this, and never stop. <i>b</i> <b>Believe in it & your abilities.</b>`],
    ...
    <b>Have empathy</b> is thankfully not an empty statement - its strength per individual is affected by both nature and nurture. Learning empathy, and all its forms, is what Aue encourages. Others' emulation of empathy is to encourage it in all beings. It is not a force of good on its own (compassion), as some beings think less of themselves and so likely others. Aue is to tactically instil joy in others so we benefit from the synergy of societal joy.`],
    ...
    ["p", `<i>o</i> <b>Some woe is incited, inflicted</b>, and as the previous thoughts summarised, it is acceptable to recognise some people act maliciously. Aue encourages protecting oneself, and the things & people in our lives that bring joy, as a first step. It is a call to resistance through defence, to not bow to fate, and to ensure there are systems and relationships in place to actively defend against inflicted woe. Truly capable subverting of societal joy is by other social beings; seeking less belligerence is a vital process of dialectics, and unfortunately sometimes attrition.`],
    ["q", `Ignorance is not malicious; we are all ignorant of things in varying degrees. However, perpetual ignorance, either upon oneself or others, we have seen does contribute to woe. This may be in the way we interact with others socially, opinions and mannerisms we inherit, continuing to do something we know is wrong, not questioning something we've been informed may be wrong, not speaking up or intervening in a situation we know is preventable.
    ...
    ["r", `To me, <b>faith in science</b> is not an oxymoron. Interacting with all other people we have ingrained in us a workable level of trust for relationships, business, peace, and guardianship, among others. It is no law of physics—you have my word—that money guarantees service, affection guarantees loyalty, or that treaties are eternal. This in mind, the human pursuits of science and academia do not guarantee truth.
